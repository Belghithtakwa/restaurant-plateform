...
import { getOwnedOrders } from "../../../../actions/order.actions";
import Spinner from "../../../utils/Spinner";
import PropTypes from "prop-types";
import { Link } from "react-router-dom";
import { format } from "date-fns";
const DashboardOrders = ({ getOwnedOrders, order, restaurant }) => {
  useEffect(() => {
    getOwnedOrders(localStorage.getItem("currentRestaurant"));
  }, [getOwnedOrders, order.loading]);
...
DashboardOrders.propTypes = {
  ...
  getOwnedOrders: PropTypes.func.isRequired,
};
